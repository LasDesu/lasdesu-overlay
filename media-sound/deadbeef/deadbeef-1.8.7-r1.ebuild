...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="aac alsa cdda converter cover dts ffmpeg flac +hotkeys lastfm mp3 musepack nls notify nullout opus oss pulseaudio shellexec +supereq threads vorbis wavpack sid +sndfile"
...
src_prepare() {
	...
	for i in adplug alac dumb ffap mms gme mono2stereo psf sc60 shn soundtouch wma; do
